  ...
  <div class="form">
          ...
          <div class="top-row">
            ...
            <div class="field-wrap">
              ...
              <input type="text" name="house_no" style="width:520px;" required autocomplete="off"/>
            </div>
              <div class="field-wrap">
              <label>
                Village/Town<span class="req">*</span>
              </label>
              <input type="text" name="village" required autocomplete="off"/>
            </div>
              <div class="field-wrap">
			   <label>
          ...
          <div class="field-wrap">
            ...
            <input type="email" name="email" required autocomplete="off"/>
              ...
              <div class="field-wrap">
            <label>
              Aadhar No<span class="req">*</span>
            </label>
            <input type="number" name="aadhar_no" required autocomplete="off"/>
          </div>
